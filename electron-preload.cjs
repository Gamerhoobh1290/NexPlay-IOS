...
contextBridge.exposeInMainWorld('NexPlayDesktop', {
  ...
  /** @type {(...args: any[]) => any} */
  resolveOnlineTrackAudioStream(payload = {}) {
    return ipcRenderer.invoke(ONLINE_AUDIO_STREAM_RESOLVE_CHANNEL, payload);
  },
  /** @type {(...args: any[]) => any} */
  searchYouTubeMusic(payload = {}) {
    return ipcRenderer.invoke(ONLINE_MUSIC_SEARCH_CHANNEL, payload);
  },
  /** @type {(...args: any[]) => any} */
  ...
  /** @type {(...args: any[]) => any} */
  fetchApprovedRemoteJson(payload = {}) {
    return ipcRenderer.invoke(REMOTE_JSON_FETCH_CHANNEL, payload);
  },
  /** @type {(...args: any[]) => any} */
